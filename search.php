                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="https://image.tmdb.org/t/p/w500/<?= $c["poster_path"] ?>">
                                        <div class="ep"><?= $c["vote_average"]; ?></div>
                                    </div>
                                    <div class="product__item__text">
                                        <h5><a href="movies.php?id=<?=$c["id"];?>"><?= $c["title"]; ?></a></h5>
                                    </div>
                                </div>
                            </div>
                            <?php
